        ...
        switch (this.formType) {
            case "select":
                ...
                if (this.selectMultiple) {
                    var selectedValues = this.values.map( function(v) { if (value.indexOf(String(v[0])) > -1) { return v[1] } })
    ...
    requestData: function () {
        ...
        if (jQuery.isArray(value)) {
          var values = []
            ...
            data[this.objectName][this.attributeName] = values
        }
        else {
            data[this.objectName][this.attributeName] = value
        }
